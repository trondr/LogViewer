...
namespace github.trondr.LogViewer.Tests.UnitTests
{
    ...
    public class EventLogItemConnectionStringParserTests
    {
        ...
        [Test]
        public void EventLogItemConnectionStringParserTest_ValidConnectionString()
        {
            
            using(var testBooStrapper = new TestBootStrapper(GetType()))
            {
                var target = testBooStrapper.Container.Resolve<IEventLogItemConnectionStringParser>();
        ...
        [Test]
        public void EventLogItemConnectionStringParserTest_NotValidConnectionString()
        {
            
            using(var testBooStrapper = new TestBootStrapper(GetType()))
            {
                var target = testBooStrapper.Container.Resolve<IEventLogItemConnectionStringParser>();
                const string testConnectionString = "eventlog:Security:localhost";
                IEventLogItemConnection expected = new EventLogItemConnection()
                {
                    Value = testConnectionString,
                    LogName = "Security",
