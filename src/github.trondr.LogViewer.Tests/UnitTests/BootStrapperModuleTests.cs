...
namespace github.trondr.LogViewer.Tests.UnitTests
{
    ...
    public class BootStrapperModuleTests
    {
        ...
        [Test]
        public void EventsHelperRegistrationTest()
        {
            BootStrapperTestsHelper.CheckThatNumberOfResolvedServicesAre<IEventsHelper>(1);
            BootStrapperTestsHelper.CheckThatResolvedServiceHasSingletonLifeCycle<IEventsHelper>();
        }         
    }
}